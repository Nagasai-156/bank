...
function App() {
    ...
    const calculate = (e) => {
        ...
        // ========================================
        // STEP 1: ELIGIBILITY CHECKS (HARD BLOCKERS)
        // ========================================

        // Check 1: Must be confirmed employee
        if (confirmed !== "YES") {
            setResult({
                eligible: false,
        ...
        // Check 2: Minimum service ≥ 2 years
        if (service < 2) {
            setResult({
                eligible: false,
        ...
        // Check 4: Existing same loan must be closed
        ...
        // Check 5: Liabilities must be regular
        ...
        // Check 6: ACR / Assets must be filed
        if (acrFiled !== "YES") {
            setResult({
                eligible: false,
        ...
        // ========================================
        // STEP 2: NTH (NET TAKE HOME) CHECK
        // ========================================
        ...
        // Two Wheeler Rules
        if (vehType === "2W") {
            // EDGE CASE: Two-wheeler + Used → Always reject
            if (condition === "USED") {
                setResult({
                    eligible: false,
        ...
        // Four Wheeler - Used Vehicle Age Check
        ...
        // ========================================
        // STEP 6: FINAL LOAN AMOUNT (CORE FORMULA)
        // ========================================

        const finalLoan = Math.min(cadreMaxLoan, eligibleByCost)

        // Calculate margin amount (what employee must pay)
        ...
        // Check if tenure will exceed age 60
        ...
        // ========================================
        // STEP 8: EMI CALCULATION (SIMPLE INTEREST)
        // ========================================

        const roi = 0.07 // 7% p.a
